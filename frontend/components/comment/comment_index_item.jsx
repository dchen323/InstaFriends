...
export default class CommentIndexItem extends React.Component {
  ...
  render() {
    ...
    if (
      this.props.sessionId === this.props.commentAuthor.id ||
      this.props.pictureAuthorId === this.props.sessionId
    ) {
      hideButton = "";
    }
    return (
      <li className="comment-body">
        <Link
          to={`/user/${this.props.commentAuthor.id}/`}
        ...
        <span className="comment-delete">
          ...
          <i
            className={`fas fa-times deleteicon ${hideButton}`}

...
export const FollowPictureItem = ({
  user,
  picture,
  likes,
  handleLike,
  ...
  let liked = likes.filter(like => like.userId === currentUser.id);
  return (
    <li className="picture-feed-container">
      ...
      <div className="picture-holder-feed">
        <img
          ...
          onDoubleClick={
            liked.length ? handleUnlike(liked[0]) : handleLike(picture.id)
          }
        />
      </div>
      <br />
      <div className="extra-info">
        ...
        <div className="comment-feed">
          <CommentIndexContainer picture={picture} commentFeed={commentFeed} />
        </div>

...
richard = User.create!({username: 'richard', name: 'Richard Burke', password: 'password1', img_url: 'http://res.cloudinary.com/dchen3/image/upload/c_scale,w_368/v1528998946/richard_friends.jpg'})
carol = User.create!({username: 'carol', name: 'Carol Willick', password: 'password1', img_url: "http://res.cloudinary.com/dchen3/image/upload/v1528999120/friends.carol_willick.jpg"})
